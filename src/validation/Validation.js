...
export function validateCount(countVal, fieldType) {
    let countValErr = "";
    if (countVal === "") {
        countValErr = "*This field is required";
    } else if (countVal < 1) {
        countValErr = `*Please enter a valid number of ${fieldType}`;
    } else if (!String(countVal).match(validRange)) {
        countValErr = `*Please enter a valid ${fieldType} count (1-7)`;
    } else {
        countValErr = "";
    }
    return countValErr;
