                ...
                <div className="fields-container">
                    ...
                    <div className="form-group">
                        ...
                        <div className='guestInputs'>
                            <div>
                                <span className='sign' onClick={() => setAdultCount(c => c - 1)}>-</span>
                                <span>{adultCount} Adults</span>
                                <span className='sign' onClick={() => setAdultCount(c => c + 1)}>+</span>
                            </div>
                            <span>|</span>
                            <div>
                                <span className='sign' onClick={() => setChildCount(c => c - 1)}>-</span>
                                <span>{childCount} {childCount > 1 ? "Children" : "Child"}</span>
                                <span className='sign' onClick={() => setChildCount(c => c + 1)}>+</span>
                            </div>
